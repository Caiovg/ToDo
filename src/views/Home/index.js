...
export default function Home({ navigation }){
    ...
    /*ele vai fazer uma requesição get antes da tela ser inicializada,
     e colocar o que retornar do banco na variavel setTasks*/
...
//map e uma estrutura de repetição
//ActivityIndicator e uma animação de loadzinho indicativo