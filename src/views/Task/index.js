...
import { View, Text, Image, ScrollView, TextInput, KeyboardAvoidingView, TouchableOpacity, Switch, Alert, ActivityIndicator } from 'react-native';
...
//usa o multiline para poder quebrar as linhas
export default function Task({ navigation, idTask }){
    ...
    async function Cadastro(){
        ...
        if(!hour)
            return Alert.alert('Defina uma hora para tarefa!');
    ...
    return(
        <KeyboardAvoidingView style={styles.container}>
            <Header ShowBack={true} onPress={New} />
            
            {
                ...
                <ScrollView style={{width: '100%'}}>
                    <ScrollView horizontal={true} showsHorizontalScrollIndicator={false} style={{marginVertical: 10 }}>
                        {
                            ...
                            <TouchableOpacity onPress={() => setType(index)}>
                                <Image source={icon} style={[styles.imageIcon, /*deixando a imagem apagada quando escolhida*/type && type != index && styles.typeIconInative]}/>
                            </TouchableOpacity>
                            ))
                        }
                    </ScrollView>
                    ...
                    <TextInput 
                        ...
                        //Pegando o que a dentro do TextIput
            ...
            <Footer icon={'save'} onPress={Cadastro}/>
